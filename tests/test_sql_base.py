...
from target_postgres.target_tools import TargetError, stream_to_target
...
def test_loading__simple():
    ...
    stream_to_target(CatStream(100), target)
...
def test_loading__nested_tables():
    ...
    stream_to_target(NestedStream(10), target)
...
def test_loading__new_non_null_column():
    cat_count = 50
    target = FakeSchemaTarget()
    stream_to_target(CatStream(cat_count), target)
    ...
    stream_to_target(non_null_stream, target)
...
def test_loading__column_type_change():
    ...
    stream_to_target(stream, target)
...
def test_loading__column_type_change__nullable():
    ...
    stream_to_target(NameNonNullCatStream(cat_count), target)
...
def test_loading__multi_types_columns():
    stream_count = 50
    target = FakeSchemaTarget()
    stream_to_target(MultiTypeStream(stream_count), target)
...
def test_loading__invalid_column_name():
    ...
    stream_to_target(non_lowercase_stream, target)
    ...
    stream_to_target(duplicate_non_lowercase_stream_1, target)
    ...
    stream_to_target(duplicate_non_lowercase_stream_2, target)
    ...
    stream_to_target(duplicate_non_lowercase_stream_3, target)
    ...
    stream_to_target(duplicate_name_too_long_stream, target)
